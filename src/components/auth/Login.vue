                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<h1>Login</h1>
								<p class="account-subtitle">medicAssist</p>
								<!-- Form -->
								<form action="">
									...
									<div class="form-group">
                                    <button @click="login" v-if="loading==false" class="btn btn-primary btn-block" type="submit">Login</button>
